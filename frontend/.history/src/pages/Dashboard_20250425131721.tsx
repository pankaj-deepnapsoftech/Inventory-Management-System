      ...
      <div className="flex flex-col  md:items-center md:justify-between gap-6 p-4 bg-white rounded-xl shadow-sm">
        ...
        >
          ...
          <div className="flex w-full md:w-auto gap-2">
            <Button
              type="submit"
              className="w-full md:w-36 h-10 text-sm font-semibold rounded-lg bg-gray-900 text-white shadow-sm hover:from-blue-800 hover:to-teal-900 hover:text-white hover:shadow-lg border border-transparent transition-all duration-300 ease-in-out"
            >
              Apply
            </Button>
            <Button
