  ...
  return (
    <div className="  p-4 rounded-md ">
      ...
      <div>
        ...
        <div className="mt-2  flex flex-col md:flex-wrap md:flex-row gap-2 md:gap-4 justify-center px-4 pb-4">
          {/* Search */}
          <textarea
          ...
          {/* Bulk Upload Button + Menu */}
          <div className="w-full md:w-[200px]">
            <button
              onClick={() => setShowBulkUploadMenu(true)}
              className="text-white bg-[#2D3748] hover:bg-[#2e2e4f] text-sm rounded-[6px] px-4 py-2 w-full flex justify-between items-center gap-2 transition-all"
            >
              Bulk Upload
            ...
            {showBulkUploadMenu && (
              <div className="mt-2 border border-[#a9a9a9] rounded p-3 bg-white shadow-md w-full">
                <form>
                  <div className="mb-2">
      ...
      <div className="flex justify-start items-center gap-2 mb-2">
        <FormControl width={"-webkit-max-content"}>
          ...
          <select
            ...
            className="mt-2 rounded border border-[#a9a9a9] py-2 px-2"
          >
