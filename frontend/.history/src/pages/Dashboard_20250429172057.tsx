        ...
        >
          <div className="w-full max-w-md">
            ...
            <input 
              ...
              className="w-full  rounded-md px-4 py-2 text-sm  text-gray-200 placeholder-gray-900   bg-[#918f8f57]  focus:outline-none transition"
            />
          ...
          <div className="w-full max-w-md">
            ...
            <input
              ...
              type="text"
              placeholder="DD/MM/YYYY"
              className="w-full  rounded-md px-4 py-2 text-sm text-gray-200 placeholder-gray-400   bg-[#918f8f57]  focus:outline-none  transition"
            />
          </div>
