  ...
  return (
    <div className=" bg-white shadow-2xl   rounded-md h-full">
      ...
      <div>
        ...
        <div className="mt-2  md:flex w-[100%] max-[700px]:flex-col px-10 md:gap-3 md:justify-center ">
        <textarea
            className="rounded-[10px] max-[700px]:w-full px-2 py-2 md:px-3 md:py-2 text-sm  border resize-none "
            rows={1}
            placeholder="Search"
            value={searchKey}
          ...
          <Button 
            ...
            backgroundColor="#2D3748"
             _hover={{ bg: "#2d3748c9", color: "white" }}
             >
