...
const Dashboard: React.FC = () => {
  ...
  return (
    <div>
      <div className="flex flex-col pb-4 md:items-center md:justify-between gap-6 p-4 backdrop-blur-lg bg-gradient-to-r from-[#657291] to-[#284d66] rounded-xl shadow-sm">
