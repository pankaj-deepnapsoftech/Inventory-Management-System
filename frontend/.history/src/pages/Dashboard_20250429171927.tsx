...
const Dashboard: React.FC = () => {
  ...
  return (
    <div>
      <div className="flex flex-col  md:items-center md:justify-between gap-6 p-4 backdrop-blur-lg bg-gradient-to-r from-[#396674] to-[#284d66] rounded-xl shadow-sm">
        <div className="text-2xl md:text-3xl text-[#23263b] font-[700]   ">
          Welcome {firstname || ""}
        </div>
        ...
        >
          <div className="w-full max-w-md">
            <label htmlFor="dob" className="block text-sm font-medium text-[#87888b] mb-1">
              FROM:
            </label>
            <input 
              value={to}
              ...
              className="w-full  rounded-md px-4 py-2 text-sm  text-gray-200 placeholder-gray-900   bg-[#63626257]  focus:outline-none transition"
            />

          </div>
          <div className="w-full max-w-md">
            <label htmlFor="dob" className="block text-sm font-medium text-[#2D3748]  mb-1">
              TO:
            </label>
            <input
              value={to}
          ...
          <div className="flex w-full md:w-auto gap-2">
            <button
              ...
              type="submit"
              className="w-full md:w-40 h-11 px-4 text-sm font-medium tracking-wide rounded-md bg-gradient-to-r from-gray-700 to-gray-800 text-white shadow-md border-none hover:from-gray-800  hover:to-gray-950 focus:outline-none  transition-all duration-300 ease-in-out"
            >
              Apply Now
            </button>
            <button
              onClick={resetFilterHandler}
              type="submit"
              className="w-full md:w-40  h-11 text-sm font-medium tracking-wide rounded-md  bg-gradient-to-r from-gray-700 to-gray-800 text-white shadow-md border-none hover:from-gray-800 hover:to-gray-950 focus:outline-none  transition-all duration-300 ease-in-out"
            >
              Reset
            </button>
          </div>
