...
const Dashboard: React.FC = () => {
  ...
  return (
    <div>
      <div className="flex flex-col  md:items-center md:justify-between gap-6 p-4 backdrop-blur-lg bg-gradient-to-lr to-[#f6b477] from-[#ef9698] rounded-xl shadow-sm">
        <div className="text-2xl md:text-3xl text-white font-[700] text-gray-800  ">
          Welcome {firstname || ""}
        </div>
