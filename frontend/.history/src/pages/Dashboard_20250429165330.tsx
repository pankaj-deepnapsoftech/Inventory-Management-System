...
const Dashboard: React.FC = () => {
  ...
  const dynamicColor = (index: number) => {
    switch (index) {
      case 0:
        return "bg-gradient-to-tl  from-[#257c97] to-[#10223a] "
        break;
      case 1:
        return "bg-gradient-to-tl  from-[#2D3748] to-[#10223a] "
        break;
      case 2:
        return "bg-gradient-to-tl from-[#2D3748] to-[#10223a] "
        break;
  ...
  return (
    <div>
      <div className="flex flex-col  md:items-center md:justify-between gap-6 p-4 backdrop-blur-lg bg-gradient-to-r from-[#f7b271] to-[#f29a96] rounded-xl shadow-sm">
        <div className="text-2xl md:text-3xl text-[#1f2630] font-[700]   ">
          Welcome {firstname || ""}
        </div>
        ...
        >
          <div className="w-full max-w-md">
            ...
            <input 
              ...
              className="w-full border border-gray-200 rounded-md px-4 py-2 text-sm  text-gray-200 placeholder-gray-300   bg-[#63626257]  focus:outline-none transition"
            />
          ...
          <div className="w-full max-w-md">
            ...
            <input
              ...
              type="text"
              placeholder="DD/MM/YYYY"
              className="w-full border border-gray-300 rounded-md px-4 py-2 text-sm text-gray-200 placeholder-gray-300    focus:outline-none  transition"
            />
          </div>
          <div className="flex w-full md:w-auto gap-2">
            <button
              ...
              type="submit"
              className="w-full md:w-40 h-11 px-4 text-sm font-medium tracking-wide rounded-md bg-gradient-to-r from-gray-600 to-gray-800 text-white shadow-md border-none hover:from-gray-800  hover:to-gray-950 focus:outline-none  transition-all duration-300 ease-in-out"
            >
              Apply Now
            </button>
            <button
              onClick={resetFilterHandler}
              type="submit"
              className="w-full md:w-40  h-11 text-sm font-medium tracking-wide rounded-md  bg-gradient-to-r from-gray-600 to-gray-800 text-white shadow-md border-none hover:from-gray-800 hover:to-gray-950 focus:outline-none  transition-all duration-300 ease-in-out"
            >
              Reset
            </button>
          </div>
      ...
      {!isLoading && (
        <div>
          ...
          {employees && (
            <div className=" flex flex-wrap max-[700px]:justify-center px-5 py-5 bg-[#d3cece38] shadow-3xl rounded-md  gap-4  ">
          ...
          {approvalsPending && (
            <div className=" flex flex-wrap max-[700px]:justify-center px-5 py-5 bg-[#d3cece38] shadow-3xl rounded-md  gap-4 ">
              <Card
                ...
                bgColor="bg-gradient-to-b from-[#2D3748] to-[#10223a] "
                textColor="black"
          ...
          {directInventory && (
            <div className="  flex flex-wrap max-[700px]:justify-center px-5 py-5 bg-[#d3cece38] shadow-3xl rounded-md  gap-4 mb-4 ">
              <Card
                primaryColor="white"
          ...
          <div className=" flex flex-wrap max-[700px]:justify-center px-5 py-5 bg-[#d3cece382] shadow-3xl rounded-md  gap-4 mb-4 ">
            <Card
              primaryColor="white"
              secondaryColor="#32A1E7"
              textColor="white"
