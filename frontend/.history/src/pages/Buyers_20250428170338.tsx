...
const Buyers: React.FC = () => {
  ...
  <Button
    ...
    width={{ base: "100%", md: 100 }}  {/* Full width on mobile, fixed width on larger screens */}
  ...
  <Button
    ...
    paddingX={{ base: "10px", md: "12px" }}
    paddingY={{ base: "0", md: "3px" }}
    width={{ base: "100%", md: 200 }}  {/* Full width on mobile, fixed width on larger screens */}
  ...
  <div className="w-full md:w-[200px]">
    <Button
      ...
      paddingX={{ base: "10px", md: "12px" }}
      paddingY={{ base: "0", md: "3px" }}
      width="100%"  {/* Full width on mobile, fixed width on larger screens */}
        ...
        <form>
          ...
          <a href={SampleCSV}>
            <Button
              type="button"
              fontSize={{ base: "14px", md: "14px" }}
              width={{ base: "100%", md: 190 }}  {/* Full width on mobile, fixed width on larger screens */}
              color="white"
              backgroundColor="#2D3748"
              className="mt-1"
              rightIcon={<AiFillFileExcel size={22} />}
