...
const Stores: React.FC = () => {
    ...
    <div className=" mx-2 rounded-md h-full " >
      <div>
        ...
        <div>
          ...
          <div className="mt-2 w-full flex flex-col md:flex-row justify-center items-start md:items-center gap-2 px-4">
  {/* Search Field */}
  <textarea
  ...
  <div className="w-full md:w-[200px]">
    ...
    {showBulkUploadMenu && (
      <div className="mt-2 border border-[#a9a9a9] rounded p-3 bg-white shadow-sm w-full">
        <form>
          <div className="mb-2">
