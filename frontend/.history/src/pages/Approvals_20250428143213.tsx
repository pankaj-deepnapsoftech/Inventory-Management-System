...
const Approvals: React.FC = () => {
  ...
  return (
    <div>
      {/* PRODUCTS */}
      <div className=" bg-white shadow-2xl rounded-md mb-3" >
        {/* Products Page */}
        <div>
          ...
          <div className="mt-2 flex  gap-y-1 justify-center gap-x-2 w-full ">
            <textarea
      ...
      <div className=" bg-white shadow-2xl rounded-md mb-3">
        ...
        <div >
          ...
          <div className="mt-2 flex  gap-y-1 justify-center gap-x-2 w-full ">
            <textarea
              className="rounded-[10px]  px-2 py-2 md:px-3 md:py-2 text-sm  border resize-none " rows={1}
              //   width="220px"
              placeholder="Search"
      ...
      <div className=" bg-white shadow-2xl rounded-md mb-3">
        {/* Buyers Page */}
        <div className="flex flex-col items-start justify-start md:flex-row gap-y-1 md:justify-between md:items-center mb-8">
          <div className=" text-center font-[700] pb-4 text-2xl pt-2">
            Suppliers for Approval
          </div>

          <div className="mt-2 flex  gap-y-1 justify-center gap-x-2 w-full ">
            <textarea
               className="rounded-[10px]  px-2 py-2 md:px-3 md:py-2 text-sm  border resize-none " rows={1}   rows={1}
              //   width="220px"
              placeholder="Search"
