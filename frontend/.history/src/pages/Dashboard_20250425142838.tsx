        ...
        >
          ...
          <div className="flex w-full  gap-2">
            ...
            onClick={resetFilterHandler}
              type="submit"
              className="w-full md:w-50 h-11  text-sm font-medium tracking-wide rounded-md bg-gradient-to-r from-gray-700 to-gray-900 text-white shadow-md border-none hover:from-gray-800 hover:to-gray-950 focus:outline-none  transition-all duration-300 ease-in-out"
            >
              Apply Now
            </button>
