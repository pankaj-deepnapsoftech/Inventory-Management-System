      ...
      <div className="flex flex-col  md:items-center md:justify-between gap-6 p-4 bg-white rounded-xl shadow-sm">
        ...
        >
          ...
          <div className="flex w-full md:w-auto gap-2">
            <button
              type="submit"
              className="w-full md:w-40 h-11 px-4 text-sm font-medium tracking-wide rounded-md bg-gradient-to-r from-red-700 to-red-900 text-white shadow-md border border-red-900 hover:from-red-800 hover:to-red-950 focus:outline-none focus:ring-2 focus:ring-red-500 transition-all duration-300 ease-in-out"
            >
              Apply Now
            </button>
