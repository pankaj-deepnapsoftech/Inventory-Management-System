        ...
        >
          ...
          <div className="flex w-full md:w-auto gap-2">
            <button
              ...
              type="submit"
              className="w-full md:w-40 h-11 px-4 text-sm font-medium tracking-wide rounded-md bg-gradient-to-r from-gray-600 to-gray-600 text-white shadow-md border-none hover:from-gray-800  hover:to-gray-950 focus:outline-none  transition-all duration-300 ease-in-out"
            >
              Apply Now
            </button>
            <button
              onClick={resetFilterHandler}
              type="submit"
              className="w-full md:w-40  h-11 text-sm font-medium tracking-wide rounded-md  bg-gradient-to-r from-gray-600 to-gray-600 text-white shadow-md border-none hover:from-gray-800 hover:to-gray-950 focus:outline-none  transition-all duration-300 ease-in-out"
            >
              Reset
            </button>
          </div>
