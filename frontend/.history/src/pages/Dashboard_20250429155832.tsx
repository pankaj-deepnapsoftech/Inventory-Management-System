...
const Dashboard: React.FC = () => {
  ...
  return (
    <div>
      <div className="flex flex-col  md:items-center md:justify-between gap-6 p-4 backdrop-blur-lg bg-gradient-to-l to-[#597881] from-[#4e41418a] rounded-xl shadow-sm">
