        ...
        >
          <div className="w-full max-w-md">
            ...
            <input
              ...
              className="w-full border-b rounded-md px-4 py-2 text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-700 focus:border-gray-700 transition"
            />
