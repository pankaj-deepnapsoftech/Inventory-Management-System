...
const ProformaInvoice: React.FC = () => {
  ...
  return (
    <div className=" bg-white shadow-2xl  mx-2 rounded-md">
      ...
      <div className="flex px-4 flex-col items-start justify-start md:flex-row gap-y-1 md:justify-between md:items-start mb-2">
        <div className="flex text-lg md:text-xl text-center font-semibold items-center gap-y-1">
          Proforma Invoices
        </div>
