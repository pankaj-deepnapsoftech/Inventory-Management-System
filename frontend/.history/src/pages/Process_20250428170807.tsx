    ...
    <div className="rounded-md ">
      ...
      <div>
        ...
        <div className="mt-2  flex flex-wrap pb-4  justify-center  w-full gap-4">
          <textarea
            className="rounded-[10px] -full px-2 py-2 md:px-3 md:py-2 text-sm focus:outline-[#2D3748] hover:outline:[#2D3748] border resize-none border-[#bbbbbb] bg-[#f9f9f9]" rows={1}
            placeholder="Search"
            value={searchKey}
