...
const Dashboard: React.FC = () => {
  ...
  return (
    <div>
      ...
      {!isLoading && (
        <div>
          <div className="mb-2 text  mt-6 font-[700] text-[25px]">
            Employee Insights
          </div>
          {employees && employees.length === 0 && (
            <div className="text-center mb-2 text">No data found.</div>
          )}
          {employees && (
            <div className=" flex flex-wrap max-[700px]:justify-center px-5 py-5 bg-white rounded-md  gap-4  ">
          ...
          <div className="mb-2 text mt-6 font-bold text-2xl">
          ...
          <div className="mb-2 text mt-5 font-bold text-2xl">
            Inventory Insights
          </div>
          {directInventory && (
            <div className="  flex flex-wrap max-[700px]:justify-center px-5 py-5 bg-white rounded-md  gap-4 mb-4 ">
              <Card
                primaryColor="white"
