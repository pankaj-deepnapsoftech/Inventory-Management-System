...
const Dashboard: React.FC = () => {
  ...
  const dynamicColor = (index: number) => {
    switch (index) {
      case 0:
        return "bg-gradient-to-b from-[#2D3748] to-[#10223a] "
        break;
      case 1:
        return "bg-gradient-to-b from-[#2D3748] to-[#10223a] "
        break;
  ...
  return (
    <div>
      <div className="flex flex-col  md:items-center md:justify-between gap-6 p-4 backdrop-blur-lg bg-gradient-to-l to-[#f6b477] from-[#ef9698] rounded-xl shadow-sm">
        ...
        >
          <div className="w-full max-w-md">
            ...
            <input 
              ...
              className="w-full border border-gray-300 rounded-md px-4 py-2 text-sm placeholder-gray-400 bg-gray-50 focus:outline-none transition"
            />
          ...
          <div className="w-full max-w-md">
            ...
            <input
              ...
              type="text"
              placeholder="DD/MM/YYYY"
              className="w-full border border-gray-300 rounded-md px-4 py-2 text-sm placeholder-gray-400  bg-gray-100 focus:outline-none  transition"
            />
          </div>
