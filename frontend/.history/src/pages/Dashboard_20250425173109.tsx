...
const Dashboard: React.FC = () => {
  ...
  return (
    <div>
      <div className="flex flex-col  md:items-center md:justify-between gap-6 p-4 bg-[#ebebeb] rounded-xl shadow-sm">
      ...
      {!isLoading && (
        <div>
          ...
          {approvalsPending && (
            <div className=" flex flex-wrap h-[200px] px-5 py-5 bg-white rounded-md  gap-4 ">
              <Card
                primaryColor="white"
