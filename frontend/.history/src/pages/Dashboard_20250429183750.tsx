    ...
    <div>
      ...
      {!isLoading && (
        <div>
          ...
          {directInventory && (
            <div className="  flex flex-wrap max-[700px]:justify-center px-5 py-5 bg-[#34739777] shadow-3xl rounded-md  gap-4 mb-4 ">
              ...
              <Card
                ...
                secondaryColor="#32A1E7"
                textColor="white"
                bgColor= "bg-gradient-to-tl from-purple-400 to-purple-600"
                title="Stock Value"
          ...
          <div className=" flex flex-wrap max-[700px]:justify-center px-5 py-5 bg-[#347397772] shadow-3xl rounded-md  gap-4 mb-4 ">
            <Card
              primaryColor="white"
              secondaryColor="#32A1E7"
              textColor="white"
