...
const Dashboard: React.FC = () => {
  ...
  const dynamicColor = (index: number) => {
    switch (index) {
      case 0:
        return "bg-gradient-to-l  from-[#2D3748] to-[#10223a] "
        break;
      case 1:
        return "bg-gradient-to-l  from-[#2D3748] to-[#10223a] "
        break;
        ...
        >
          <div className="w-full max-w-md">
            ...
            <input 
              ...
              className="w-full border border-gray-300 rounded-md px-4 py-2 text-sm placeholder-gray-100 bg-transparent focus:outline-none transition"
            />

          </div>
          <div className="w-full max-w-md">
            <label htmlFor="dob" className="block text-sm font-medium text-g mb-1">
              TO:
            </label>
            <input
              value={to}
