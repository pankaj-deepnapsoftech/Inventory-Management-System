        ...
        >
          <div className="w-full max-w-md">
            ...
            <input 
              ...
              className="w-full border border-gray-300 rounded-md px-4 py-2 text-sm placeholder-gray-400 bg-gray focus:outline-none transition"
            />
          ...
          <div className="w-full max-w-md">
            ...
            <input
              ...
              type="text"
              placeholder="DD/MM/YYYY"
              className="w-full border border-gray-300 rounded-md px-4 py-2 text-sm placeholder-gray-400  bg-gray-400 focus:outline-none  transition"
            />
          </div>
