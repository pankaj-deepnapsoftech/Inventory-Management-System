...
const Dashboard: React.FC = () => {
  ...
  return (
    <div>
      <div className="flex flex-col  md:items-center md:justify-between gap-6 p-4 backdrop-blur-lg bg-gradient-to-r from-[#5d7cac] to-[#474b4d93] rounded-xl shadow-sm">
