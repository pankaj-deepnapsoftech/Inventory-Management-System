        ...
        >
          <div className="w-full max-w-md">
            ...
            <input 
              ...
              className="w-full border border-gray-300 rounded-md px-4 py-2 text-sm  placeholder:text-white placeholder-gray-100 bg-transparent focus:outline-none transition"
            />
