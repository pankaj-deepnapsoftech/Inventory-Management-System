    ...
    <div>
      <div className="flex flex-col  md:items-center md:justify-between gap-6 p-4 bg-white rounded-xl shadow-sm">
        ...
        >
          ...
          <Button
  type="submit"
  className="w-full md:w-36 h-10 text-sm font-semibold rounded-lg bg-gradient-to-r from-teal-500 to-blue-600 text-white shadow-sm hover:from-white hover:to-white hover:text-blue-700 hover:shadow-lg hover:border-blue-600 border border-transparent transition-all duration-300 ease-in-out"
>
  Apply
</Button>
