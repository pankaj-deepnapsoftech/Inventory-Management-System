...
const Dashboard: React.FC = () => {
  ...
  const dynamicColor = (index: number) => {
    switch (index) {
      ...
      case 1:
        return "bg-gradient-to-tl from-green-400 to-blue-500";
      case 2:
        return "bg-gradient-to-tl from-yellow-400 to-red-500";
      case 3:
        return "bg-gradient-to-tl from-green-400 to-purple-600";
      case 4:
        return "bg-gradient-to-tl from-teal-400 to-cyan-500";
      default:
        return "bg-gradient-to-tl from-gray-300 to-gray-400"; // fallback
    }
  };
  ...
  return (
    <div>
      <div className="flex flex-col  md:items-center md:justify-between gap-6 p-8 backdrop-blur-lg bg-gradient-to-r from-[#657291] to-[#284d66] rounded-xl shadow-sm">
