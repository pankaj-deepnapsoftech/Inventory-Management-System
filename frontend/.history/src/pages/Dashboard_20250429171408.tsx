...
const Dashboard: React.FC = () => {
  ...
  return (
    <div>
      <div className="flex flex-col  md:items-center md:justify-between gap-6 p-4 backdrop-blur-lg bg-gradient-to-r from-[#8c839bcc ] to-[#fcdb5b4 29a96] rounded-xl shadow-sm">
