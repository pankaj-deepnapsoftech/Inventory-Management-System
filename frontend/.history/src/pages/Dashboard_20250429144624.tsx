...
const Dashboard: React.FC = () => {
  ...
  return (
    <div>
      <div className="flex flex-col  md:items-center md:justify-between gap-6 p-4 bg-transparent border border-gray-400 rounded-xl shadow-sm">
        <div className="text-2xl md:text-3xl font-[700] text-gray-800 underline underline-offset-8 ">
          Welcome {firstname || ""}
        </div>
      ...
      {!isLoading && (
        <div>
          <div className="mb-2  mt-6 font-[700] text-[25px]">
            Employee Insights
          </div>
          ...
          {employees && (
            <div className=" flex flex-wrap max-[700px]:justify-center px-5 py-5 bg-transparent border border-gray-400 rounded-md  gap-4  ">
          ...
          {directInventory && (
            <div className="  flex flex-wrap max-[700px]:justify-center px-5 py-5 bg-transparent border border-gray-400 rounded-md  gap-4 mb-4 ">
              <Card
                primaryColor="white"
