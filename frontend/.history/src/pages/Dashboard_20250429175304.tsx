...
const Dashboard: React.FC = () => {
  ...
  const dynamicColor = (index: number) => {
    switch (index) {
      case 0:
        return "bg-gradient-to-tl  from-purple-600 to-purple-800 "
        break;
      case 1:
        return "bg-gradient-to-tl  from-purple-600 to-purple-800 "
        break;
  ...
  return (
    <div>
      <div className="flex flex-col  md:items-center md:justify-between gap-6 p-4 backdrop-blur-lg bg-gradient-to-r from-[#808dac] to-[#284d66] rounded-xl shadow-sm">
