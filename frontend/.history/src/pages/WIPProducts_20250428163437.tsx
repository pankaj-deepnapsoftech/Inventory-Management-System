  ...
  return (
    <div className=" bg-white shadow-2xl  mx-2 rounded-md h-full">
      ...
      <div>
        ...
        <div className="mt-2 w-full flex flex-col md:flex-row justify-center items-center gap-2 px-4">
  {/* Search Box */}
  <textarea
    className="w-full md:w-auto rounded-[10px] px-3 py-2 text-sm border resize-none focus:outline-[#2D3748] border-[#bbbbbb] bg-[#f9f9f9]"
    rows={1}
    placeholder="Search"
    value={searchKey}
