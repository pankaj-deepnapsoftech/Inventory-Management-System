...
<<<<<<< HEAD
      <div className="h-[90vh] overflow-hidden flex ">
        <div
          className="h-[inherit] border: none overflow-x-hidden overflow-y-auto w-0 md:w-[250px] "
=======
      <div className="h-[90vh] overflow-hidden  flex gap-x-2">
        <div
          className="h-[inherit] border: none overflow-x-hidden overflow-y-auto w-0 md:w-[230px] "
