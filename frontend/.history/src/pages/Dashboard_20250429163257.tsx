...
const Dashboard: React.FC = () => {
  ...
  const dynamicColor = (index: number) => {
    switch (index) {
      case 0:
        return "bg-gradient-to-tl  from-[#2D3720] to-[#10223a] "
        break;
      case 1:
        return "bg-gradient-to-tl  from-[#2D3720] to-[#10223a] "
        break;
      case 2:
        return "bg-gradient-to-tl from-[#2D37420 to-[#10223a] "
        break;
      case 3:
        return "bg-gradient-to-tl  from-[#2D3720] to-[#10223a] "
        break;
  ...
  return (
    <div>
      <div className="flex flex-col  md:items-center md:justify-between gap-6 p-4 backdrop-blur-lg bg-gradient-to-l to-[#597881] from-[#e2a0a1] rounded-xl shadow-sm">
