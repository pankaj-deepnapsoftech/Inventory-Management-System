...
const Invoice: React.FC = () => {
  ...
  return (
    <div className=" rounded-md  px-3 bg-white shadow-md ">
      {isAddInvoiceDrawerOpened && (
        <AddInvoice
      ...
      <div className="">
       <h1 className=" text-[20px] text-center  font-[700]">Invoices</h1>

        <div className="flex ">
          <textarea
            className="rounded-[10px]  md:flex-1 px-2 py-2 md:px-3 md:py-2 text-sm focus:outline-[#1640d6] hover:outline:[#1640d6] border resize-none border-[#bbbbbb] bg-[#f9f9f9]"
            rows={1}
            placeholder="Search"
            value={searchKey}
