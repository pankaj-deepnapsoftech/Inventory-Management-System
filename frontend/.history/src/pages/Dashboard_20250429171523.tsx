...
const Dashboard: React.FC = () => {
  ...
  const dynamicColor = (index: number) => {
    switch (index) {
      case 0:
        return "bg-gradient-to-r from-[#f7b271] to-[#fcdb5b4 29a96]"
        break;
      case 1:
        return "bg-gradient-to-r from-[#f7b271] to-[#fcdb5b4 29a96]"
        break;
  ...
  return (
    <div>
      <div className="flex flex-col  md:items-center md:justify-between gap-6 p-4 backdrop-blur-lg bg-gradient-to-r from-[#f7b271] to-[#fcdb5b4 29a96] rounded-xl shadow-sm">
