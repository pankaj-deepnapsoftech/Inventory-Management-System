  ...
  return (
    <div className=" bg-white shadow-2xl  mx-2 rounded-md">
      ...
      <div>
        ...
        <div className="mt-2 md:mt-0 flex justify-center gap-y-1 items-start gap-x-2 w-full md:w-fit">
          ...
          <textarea
            className="rounded-[10px] w-full md:flex-1 px-2 py-2 md:px-3 md:py-2 text-sm  border resize-none  hover:bg-[#2D3748]"
            rows={1}
            placeholder="Search"
            value={searchKey}
