...
const Invoice: React.FC = () => {
  ...
  return (
    <div className=" rounded-md  px-3 bg-white shadow-md ">
      ...
      <div className="">
        <h1 className=" text-[20px] text-center pb-4 font-[700]">Invoices</h1>
        ...
        <div className="flex gap-3 justify-center ">
          ...
          <input
            className="rounded-[10px] w-fit border border-gray-300 focus:outline-none px-2 py-2 md:px-3 md:py-2 text-sm "
