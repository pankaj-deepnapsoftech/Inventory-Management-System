    ...
    <div>
      <div className="flex flex-col  md:items-center md:justify-between gap-6 p-4 bg-white rounded-xl shadow-sm">
        ...
        >
          ...
          <Button
  type="submit"
  className="w-full md:w-36 h-10 text-sm font-semibold rounded-lg bg-gray-800 text-white shadow-sm hover:bg-blue-600 hover:scale-105 hover:shadow-lg border border-transparent transition-all duration-300 ease-in-out"
>
  Apply
</Button>
