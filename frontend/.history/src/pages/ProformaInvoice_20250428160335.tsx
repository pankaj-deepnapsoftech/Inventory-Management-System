...
const ProformaInvoice: React.FC = () => {
  ...
  <textarea
    className="rounded-[10px] w-full md:w-auto px-3 py-2 text-sm border resize-none"
    rows={1}
    placeholder="Search"
    value={searchKey}
  ...
  <button
    className="text-white bg-[#2D3748] hover:bg-[#2d3748c9] hover:text-white text-sm rounded-[6px] px-4 py-2 w-full md:w-[200px] transition-all"
