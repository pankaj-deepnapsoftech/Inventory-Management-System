    ...
    <div className="space-y-4">
      ...
      <div className="bg-white shadow-2xl rounded-md mb-3">
        <div>
          ...
          <div className="mt-2 flex flex-wrap gap-y-1 justify-center gap-x-2 w-full">
            <textarea
              className="rounded-[10px] px-2 py-2 md:px-3 md:py-2 text-sm border resize-none w-full md:w-[220px]"
              rows={1}
              placeholder="Search"
        ...
        <div>
          ...
          <div className="mt-2 flex flex-wrap gap-y-1 justify-center gap-x-2 w-full">
            ...
            <Button
              ...
              paddingX={{ base: "10px", md: "12px" }}
              paddingY={{ base: "0", md: "3px" }}
              width={{ base: "100%", md: "100px" }}  {/* Full width on mobile, smaller on desktop */}
