    ...
    <div>
      ...
      {!isLoading && (
        <div>
          ...
          {employees && (
            <div className=" flex flex-wrap max-[700px]:justify-center px-5 py-5 bg-transparent shadow-xl  rounded-md  gap-4  ">
          ...
          {directInventory && (
            <div className="  flex flex-wrap max-[700px]:justify-center px-5 py-5 bg-transparent shadow-xl  rounded-md  gap-4 mb-4 ">
              <Card
                primaryColor="white"
