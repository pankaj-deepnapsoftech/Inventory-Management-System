      ...
      <div className="flex flex-col  md:items-center md:justify-between gap-6 p-4 bg-white rounded-xl shadow-sm">
        ...
        >
          ...
          <div className="flex w-full md:w-auto gap-2">
            ...
            onClick={resetFilterHandler}
              type="submit"
              className="w-full md:w-40 h-11 px-2 text-sm font-medium tracking-wide rounded-md bg-gradient-to-r from-gray-700 to-gray-900 text-white shadow-md border-none hover:from-gray-800 hover:to-gray-950 focus:outline-none  transition-all duration-300 ease-in-out"
            >
             Reset
            </button>
          </div>
