...
const Dashboard: React.FC = () => {
  ...
  return (
    <div>
<div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 p-4 bg-white rounded-xl shadow-sm">
  ...
  >
    <FormControl className="w-full md:w-auto">
      ...
      <Input
        ...
        type="date"
        className="w-full md:w-44 h-10 text-sm px-3 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-gray-700"
      />
    </FormControl>
