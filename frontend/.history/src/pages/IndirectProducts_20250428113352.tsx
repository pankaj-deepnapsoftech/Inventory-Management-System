  ...
  return (
    <div className="bg-white shadow-2xl p-4 rounded-md ">
      ...
      <div>
        ...
        <textarea
            className="rounded-[10px] md:flex-1 px-2 py-2 md:px-3 md:py-2 text-sm focus:outline-[#2D3748] hover:outline:[#2D3748] border resize-none border-[#bbbbbb] bg-[#f9f9f9]"
            rows={1}
            placeholder="Search..."
            value={searchKey}
