...
const InventoryApprovals: React.FC = () => {
  ...
  return (
    <div className="p-4 md:p-6">
      <div className="bg-gray-300 shadow-md rounded-lg px-4 py-5 md:px-6 md:py-6">
        <div className="flex  items-start md:items-center justify-between mb-5 gap-3">
          <h1 className="text-2xl font-[700] text-[#2D3748]">
            Inventory Approvals
          </h1>
