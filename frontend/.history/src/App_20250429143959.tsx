...
const App: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-purple-500 via-blue-500 to-indigo-600 backdrop-blur-sm">
 <div className="backdrop-blur-md bg-white/10 min-h-screen"></div>
      <ToastContainer />
      <BrowserRouter>
        <Routes>
