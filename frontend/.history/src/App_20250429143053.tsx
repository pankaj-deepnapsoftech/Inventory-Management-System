...
const App: React.FC = () => {
  ...
  return (
    <div>
      <img className="h-full backdrop-blur-2xl  " src="https://img.freepik.com/free-vector/abstract-big-data-digital-technology-background-design_1017-22920.jpg?t=st=1745917186~exp=1745920786~hmac=98b9b64f532c35706794ff5eeae7f4ac8362f4f2c7906b30c5479dea7ada7082&w=740" alt="" />
      <ToastContainer />
      <BrowserRouter>
        <Routes>
