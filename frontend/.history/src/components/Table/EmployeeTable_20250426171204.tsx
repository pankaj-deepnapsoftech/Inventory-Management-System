            ...
            <Table variant="simple" {...getTableProps()}>
              <Thead className="text-sm font-semibold bg-[#2D3748]">
                {headerGroups.map(
                  (
                    ...
                    return (
                      <Tr {...hg.getHeaderGroupProps()} borderBottom="1px solid #e2e8f0"  bgColor={dynamicBg(Index)}>
              ...
              <Tbody {...getTableBodyProps()}>
                {page.map((row: any) => {
                  ...
                  return (
                    <Tr
                      className="relative hover:bg-[#f5f5f5] hover:cursor-pointer text-base lg:text-sm"
                      {...row.getRowProps()}
