    ...
    <div>
      ...
      {!isLoadingProducts && products.length > 0 && (
        <div>
          ...
          <TableContainer maxHeight="600px" overflowY="auto" className="bg-white rounded-md" >
            <Table variant="simple" {...getTableProps()} >
              ...
              <Tbody {...getTableBodyProps()}>
                {page.map((row: any,index) => {
                  ...
                  return (
                    <Tr
                      className="relative hover:bg-[#e4e4e4] font-[700] hover:cursor-pointer text-md lg:text-sm"
                      {...row.getRowProps()}
                      _hover={{
                        bg: "gray.50",
                        cursor: "pointer",
