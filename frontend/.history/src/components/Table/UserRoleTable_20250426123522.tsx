...
const UserRoleTable: React.FC<UserRoleTableProps> = ({
  ...
  return (
    <div className="border border-red-500 flex justify-center flex-col items-center">
    ...
    <Thead bg="#2D3748" >
      {headerGroups.map((hg) => (
        <Tr {...hg.getHeaderGroupProps()} borderBottom="1px solid #e2e8f0">
          ...
          <Th fontSize="15px" fontWeight="600" color="gray.700" whiteSpace="nowrap" p={3} borderBottom="1px solid #e2e8f0">Actions</Th>
        </Tr>
      ))}
    </Thead>
