...
>
        ...
        <div className="mt-[40px]">
          <button className="flex items-center justify-center ml-4 h-[40px] w-[150px] gap-2 bg-gradient-to-r from--500 to-cyan-900 hover:bg-cyan-100 text-white py-2 rounded-md transition-all">
            Log Out
            <FaSignOutAlt />
          </button>
        </div>
