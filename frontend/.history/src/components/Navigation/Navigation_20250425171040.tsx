...
const Navigation: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div 
        className={`bg-gradient-to-b from-[#2D3748] to-[#10223a]  text-white h-full overflow-auto md:block ${
    ...
    <img src={logo} alt="blogger" className="w-[190px] filter invert" />
        ...
        <hr className="my-4 border-1.5 w-[180px] ml-4 relative top-10 border-gray-300" />
        <div className="mt-[150px]">
    <button className="flex items-center justify-center ml-4 h-[30px] w-[150px] gap-2 bg-gradient-to-r from-red-500 to-red-700 hover:bg-red-600 text-white py-2 rounded-md transition-all">
      Log Out
      <FaSignOutAlt />
    </button>
  </div>
