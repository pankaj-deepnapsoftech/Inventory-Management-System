...
>
        ...
        <div className="mt-[40px]">
          <button className="flex items-center justify-center ml-4 h-[40px] w-[150px] gap-2 bg-gradient-to-r from-cya-500 to-gray-700 hover:bg-gray-600 text-white py-2 rounded-md transition-all">
            Log Out
            <FaSignOutAlt />
          </button>
        </div>
