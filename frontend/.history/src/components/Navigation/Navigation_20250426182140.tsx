...
>
        ...
        <div className="mt-[40px]">
          <button className="flex items-center shadow-2xl justify-center ml-4 h-[40px] w-[150px] gap-2 bg-gradient-to-r from-white to- hover:scale-105 text-white py-2 rounded-md transition-all">
            Log Out
            <FaSignOutAlt />
          </button>
        </div>
