...
const Navigation: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div 
  className={`bg-gradient-to-b from-[#262f3d] to-[#0f1018] backdrop-blur-xl text-white h-full overflow-auto scrollbar-hidden transition-all decoration-purple-500 md:block ${
