  ...
  return (
    <>
      ...
      <div
        ...
        fixed z-40 w-64 md:w-auto top-0 left-0 px-3 py-3 transition-transform duration-300 ease-in-out 
        ${checkMenu ? "transform translate-x-0" : "transform translate-x-[-100%]"}
        md:block`}
      >
        {/* Logo */}
