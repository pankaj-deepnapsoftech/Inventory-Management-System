...
const Navigation: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div 
        className={`bg-gradient-to-b from-[#2D3748] to-[#10223a] backdrop-blur-xl text-white h-full overflow-auto md:block ${
          ...
          {routes.map((route, ind) => {
            ...
            if (route.isSublink) {
              ...
              return (
                ...
                >
                  <li className="flex gap-x-2 pl-3 pr-9 py-3 rounded-lg hover:bg-gradient-to-b from-[#3838383833433] to-[#36312e] hover:text-whitetext-[15px] font-semibold">
                    <span>{route.icon}</span>
                    <span>{route.name}</span>
                  </li>
                </NavLink>
