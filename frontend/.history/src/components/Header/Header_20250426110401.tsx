...
const Header: React.FC = () => {
  ...
  return (
    <div className="relative flex justify-end max-[800px]:justify-end items-center py-2 px-3 bg-gradient-to-b from-[#2D3748] to-[#10223a]"
    style={{ boxShadow: "0 0 20px 3px #96beee26" }}> 
    
      <div className="flex gap-x-5 items-center   ">
        <IoIosNotifications size={40} color="" />
