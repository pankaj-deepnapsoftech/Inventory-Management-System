...
const AddUserRole: React.FC<AddUserRoleProps> = ({
  ...
  return (
    <Drawer closeDrawerHandler={closeDrawerHandler}>
      ...
      >
        <h1 className="px-4 flex gap-x-2 items-center font-bold text-[20px] py-3 border-b">
          <BiX onClick={closeDrawerHandler} size="30px" />
          User Role
        </h1>

        <div className="mt-8 px-5 ">
          <h2 className="text-md font-semibold py-2 px-4  text-white text-center cursor-pointer hover:bg-[#2d37486e] rounded-md mb-6 w-[200px] bg-[#2D3748] transition-all duration-100">
            Add New Role
          </h2>
