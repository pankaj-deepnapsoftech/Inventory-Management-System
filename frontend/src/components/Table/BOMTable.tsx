    ...
    <div>
      ...
      {!isLoadingBoms && boms.length > 0 && (
        <div>
          ...
          <p>Select BOMs to start the process.</p>

          <TableContainer maxHeight="600px" overflowY="auto">
            <Table
              className="table-auto my-5"
              variant="simple"
              {...getTableProps()}
            >
              <Thead className="text-sm font-semibold bg-blue-500">
                {headerGroups.map(
                  (
                    hg: HeaderGroup<{
                      bom_name: string;
              ...
              <Tbody {...getTableBodyProps()}>
                {page.map((row: any) => {
                  ...
                  return (
                    <Tr
                      className="relative hover:bg-gray-100 hover:cursor-pointer text-base lg:text-sm"
                      {...row.getRowProps()}
                    >
                      <Td>
                        <Checkbox className="border-2 rounded
                         border-gray-600"
                         ></Checkbox>
                      </Td>
          ...
          <Button
            className="float-end my-3 border"
            fontSize={{ base: "14px", md: "14px" }}
            color="#22c55e"
            borderColor="#22c55e"
            backgroundColor="#ffffff"
            disabled
            _hover={{ backgroundColor: "#22c55e", color: "#ffffff" }}
          >
            Start Process
          </Button>
